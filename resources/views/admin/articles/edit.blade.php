            ...
            <div class="card-body">
                ...
                <div class="container">
                    ...
                    <form method="POST" action="{{route('articles.update',$article->id)}}" enctype="multipart/form-data">
                        ...
                        @method('PUT')
                        <div class="row mb-4">
                            <img class="offset-6" style="height: 200px; width: 200px;" src="{{url('images/articles/'. $article->image)}}" alt="">
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control text-left" value="{{$article->title}}"  dir="rtl" name="title">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label  class="col-sm-2 col-form-label">متن مقاله</label>
                            <div class="col-sm-10">
                                <textarea name="body" id="editor" class="form-control text-left" rows="5">
                                    {{$article->body}}
                                </textarea>
                            </div>
                        </div>
